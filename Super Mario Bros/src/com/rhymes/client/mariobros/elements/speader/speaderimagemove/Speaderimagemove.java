package com.rhymes.client.mariobros.elements.speader.speaderimagemove;
...
import com.rhymes.client.mariobros.elements.speader.Speader;
	...
	public class Speaderimagemove implements Animation {
		
		public static int moveSpeed = 10;
		public static Bitmap[] bitmap=null;
		public static Bitmap bitmap1;
		private  Speader Statimg1;
 int r=0;
...
//				.getHeight(), null, true);
		...
		public Speaderimagemove( Speader star) {
//			if(flag)
//				{setimg();flag=false;}
			Statimg1=star;
